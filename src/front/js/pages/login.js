...
const Login = () => {
    return (
        <div className='container'>
            <form className="register-form d-flex flex-column bg-light aling-items-center text-center mx-auto my-5 p-5" action="#" /*onSubmit={actions.handleSubmit}¨*/ method="GET">
                ...
                <Link className="bg-dark w-25 rounded-4 p-1 mx-auto text-light fs-5 mt-3" to="/singup" > Crear cuenta </Link>
            </form>
        </div>
    )
}
