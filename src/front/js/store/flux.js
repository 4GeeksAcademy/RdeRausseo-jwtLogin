		...
		actions: {
			...
			handleSubmit: async (e) => {
				...
				try {
					...
					const response = await fetch("https://orange-potato-97jqjpg4wp5vh9rqj-3001.app.github.dev/api/signup", {
						method: "POST",
						headers: {
			...
			handleSubmitLogin: async (e) => {
				...
				try {
					...
					const response = await fetch("https://orange-potato-97jqjpg4wp5vh9rqj-3001.app.github.dev/api/login", {
						method: "POST",
						headers: {
							"Content-type": "application/json"
						},
